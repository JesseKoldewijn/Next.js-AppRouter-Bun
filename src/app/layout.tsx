...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="h-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-gray-700 to-gray-600">
        <Navbar />
        <div className="inset-0 flex h-full min-h-screen w-full flex-col items-center justify-center ">
